...
public class PlanetManager : MonoBehaviour
{
	...
	private PlanetaryOrbit.Parameter[] planetParameters = new PlanetaryOrbit.Parameter[planetNames.Length];
	private PlanetaryOrbit.Parameter[] moonParameters = new PlanetaryOrbit.Parameter[moonNames.Length];
    ...
    void Awake()
    {
        ...
        planetParameters[0] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams]
        {
            0.2056f,
            0.3075f * scaleRp,
            0.241f,
        ...
        planetParameters[1] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
            0.0067f,
            0.718f * scaleRp,
            0.615f,
            0.95f,
        ...
        planetParameters[2] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
            0.0167f,
            0.9833f * scaleRp,
            1f,
            1f,
        ...
        planetParameters[3] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
            0.0934f,
            1.3814f * scaleRp,
            1.882f,
            0.53f,
        ...
        planetParameters[4] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
            0.0488f,
            4.950f * scaleRp,
            11.86f ,
            11f,
        ...
        planetParameters[5] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
            0.0542f,
            9.021f * scaleRp,
            29.457f ,
            9.14f,
		...
		planetParameters [6] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
			0.0472f,
			18.286f * scaleRp,
			84.016f ,
			4f,
		...
		planetParameters [7] = new PlanetaryOrbit.Parameter(new float[numOfPlanetParams] {
			0.0086f,
			29.81f * scaleRp,
			164.791f,
			3.9f,
		...
		moonParameters [0] = new PlanetaryOrbit.Parameter(new float[numOfMoonParams] {
			0.055f,
			2.44f,
			0.074f,
			0.273f,
	...
	void CreatePlanet (string name, Material material, PlanetaryOrbit.Parameter par)
	{
		...
		AddRigidBody (ref planet, Scales.massScale * par.mass);

		planet.transform.Find ("Planet").name = meshChildPrefix + name;
		planet.transform.Find ("BB").name = "BB" + name;

		planet.transform.localScale = new Vector3 (par.radius, par.radius, par.radius);

		planet.GetComponent<PlanetaryOrbit> ().Par = par;
		planet.transform.parent = transform;

		AddSphereCollider (ref planet, Scales.gravityColliderMult * Scales.massScale * par.mass);
	}

	void CreateMoon (string name, string parentName, Material material, PlanetaryOrbit.Parameter par)
	{
		...
		moon.transform.localScale = new Vector3 (par.radius, par.radius, par.radius);
